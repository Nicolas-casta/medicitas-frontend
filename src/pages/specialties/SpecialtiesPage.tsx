...
import { getSpecialties, createSpecialty, updateSpecialty, deactivateSpecialty } from '../../api/specialties'
                ...
                {specialties.map(s => (
                    <div key={s.id} className="bg-slate-800 border border-slate-700 rounded-xl p-4 flex justify-between items-center">
                        ...
                        <div className="flex gap-2">
                            ...
                            <Button variant="danger" onClick={() => handleDeactivate(s.id)}>Desactivar</Button>
                        </div>
                    </div>
                ))}
            </div>
